...
const Pizza = subscribe()(props=>{
  ...
  return (
    ...
    <Card >
      <CardActionArea>
        ...
        <CardContent>
          ...
          { typeOfFood !== 'drinks' && typeOfFood !== 'drippings' &&
          ...
          <Grid container direction="column">
            { typeOfFood ==='pizzas' && item.sizes.length !== 0 && item.sizes.sort((a,b)=> a.price < b.price).map((size,indexSize)=>(
    ...
    {edit && 
      <EditSave  setToggle={setEdit} uuid={item.uuid} typeOfFood={typeOfFood} toggle={edit} foodItem={item} action={'edit'}/>
    }
  </div>
)});
